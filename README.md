...
|-------|----------------|
| [`cancer-multiomics`](skills/cancer-multiomics/) | TCGA/GEO data retrieval, differential expression (DESeq2), pathway analysis (GSEA, ORA, GSVA), mutation analysis (maftools, TMB, signatures), copy number variation (GISTIC2, segment analysis), DNA methylation (minfi, ChAMP, DMRcate, CIMP subtypes), gene ID conversion, batch correction |
