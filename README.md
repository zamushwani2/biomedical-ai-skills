...
| [`single-cell-atlas`](skills/single-cell-atlas/) | scRNA-seq pipeline — MAD-based QC, doublet detection ([scDblFinder](https://bioconductor.org/packages/scDblFinder/)), normalization ([SCTransform](https://satijalab.org/seurat/articles/sctransform_vignette)), batch integration ([Harmony](https://portals.broadinstitute.org/harmony/), [scVI](https://scvi-tools.org/)), Leiden clustering, cell type annotation ([CellTypist](https://www.celltypist.org/), [scType](https://github.com/IanevskiAleksandr/sc-type)). [Seurat v5](https://satijalab.org/seurat/) + [scanpy](https://scanpy.readthedocs.io/) | — |
